  ...
  <section>
      ...
      <div class="flex justify-center">
        <div class="main2 flex flex-col justify-center mt-28 text-2xl w-5/6">
            <div class="w-5/6 ">
                <div class="fl flex flex-row">Каталог &nbsp;/&nbsp;&nbsp; <div class="text-[#EA7102]">Orange pi</div></div>
            </div>
        <div class="text-[#D2D2D2] lana md:text-[150px] lg:text-[220px] xl:text-[255px] justify-start font-extrabold hhhh">Orange <br> pi</div>
        </div>
      </div>

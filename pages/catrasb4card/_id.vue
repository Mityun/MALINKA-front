      ...
      <div class="flex justify-center">
        ...
        >
          <div class="w-auto">
            ...
            >
              <NuxtLink to="/rasb" style="white-space: nowrap">
                Каталог &nbsp;/
              </NuxtLink>
              <NuxtLink
                to="/rasb"
              ...
              <NuxtLink
                class="text-[#BC1142]"
                to="/catrasb4card/catrasb4"
                style="white-space: nowrap"
              >
                Raspberry Pi 4
              </NuxtLink>
              &nbsp; / &nbsp;
              <div class="text-[#BC1142]" style="white-space: nowrap">
                {{ base.name }}
              </div>
            </div>
          </div>
          ...
          <div class="flex flex-row justify-start md:flex-col md:gap-y-2">
            ...
            <div class="ml-4 flex basis-[45%] flex-col md:ml-0 md:basis-auto">
              ...
              <div
                ...
                class="stasik mt-10 flex h-[60px] w-full items-center justify-center rounded-[100px] border-2 border-[#BC1142] bg-[#BC1142] px-8 py-3 text-2xl font-medium text-white"
              ...
              <div
                v-else
                class="mt-10 flex h-[60px] w-full items-center justify-center rounded-[100px] border-2 border-[#BC1142] bg-white px-8 py-3 text-2xl font-medium text-[#BC1142]"
              >
                В корзине
              </div>

              <div
                class="mt-10 grid h-[60px] grid-cols-3 rounded-full border-2 border-[#BC1142]"
              ...
              >
                <div
                  ...
                  @click="minus(base)"
                >
                  <img src="@/assets/Line10red.svg" alt="" />
                </div>
                <div
                  :id="base.id"
                  class="p-auto flex w-auto items-center justify-center text-xl font-bold text-[#BC1142]"
                >
                  {{ base.count }}
                </div>
                <div
                  ...
                  @click="plus(base)"
                >
                  <img src="@/assets/Group30red.svg" alt="" />
                </div>
              </div>
            </div>
          </div>

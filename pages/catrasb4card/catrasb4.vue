<template>
    <section>
        ...
        <div class="flex justify-center">
            <img src="@/assets/Ellipse21.svg" width="100%" alt="" class="pic1 overflow-hidden max-w-[1466px]" />
        </div>
        <div class="flex justify-center back" >
...
export default {
    ...
    methods: {
        ...
        openUser(item) {
            this.$router.push('/catrasb4card/' + item.id)
        },
        cartAdd(item) {

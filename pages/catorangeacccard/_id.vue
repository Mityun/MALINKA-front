  ...
  <div class="pt-6">
            ...
            >
                <div class="max-w-[1066px]">
                    <div class="fl flex flex-row">
                        ...
                        &nbsp; / &nbsp;
                        <NuxtLink class="text-[#EA7102]" to="/catorangeacccard/catorangeacc">Аксессуары</NuxtLink>
                        &nbsp; / &nbsp;
    ...
    <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
      ...
      <div class="mt-4 lg:row-span-3 lg:mt-0">
        ...
        <p class="text-3xl tracking-tight text-gray-900">{{Number(base.price).toLocaleString('ru-RU')}} ₽</p>
        ...
        <form class="mt-10">
          ...
          <button type="submit" class="mt-10 flex w-full items-center justify-center rounded-md border-2 border-[#EA7102] px-8 py-3 text-base font-medium text-[#EA7102]" @click.prevent="cartAdd(base)">Добавить в корзину</button>
        </form>
      </div>
